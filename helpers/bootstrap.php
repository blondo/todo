<?php
    $categories = array(
        array('name'=> "HTML", 'create_date'=>"13.04.2014", 'creater'=>"MHE", 'status'=>1),
        array('name'=> "CSS", 'create_date'=>"20.06.2014", 'creater'=>"MHE", 'status'=>1),
        array('name'=> "JavaScript", 'create_date'=>"26.07.2014", 'creater'=>"MHE", 'status'=>0)
    );

    $priorities = array(
        array('name'=> "sehr hoch", 'create_date'=>"03.04.2014", 'creater'=>"MHE", 'status'=>1),
        array('name'=> "hoch", 'create_date'=>"20.06.2014", 'creater'=>"MHE", 'status'=>1),
        array('name'=> "mittel", 'create_date'=>"26.07.2014", 'creater'=>"MHE", 'status'=>1),
        array('name'=> "klein", 'create_date'=>"20.06.2014", 'creater'=>"MHE", 'status'=>1),
        array('name'=> "ohne", 'create_date'=>"26.07.2014", 'creater'=>"MHE", 'status'=>1)
    );
